...
const TestimonialsSection: React.FC = () => {
  return (
    ...
    <section className="w-full py-12 md:py-24 lg:py-30  dark:bg-gray-800">
      ...
      <div className="container px-4 md:px-6">
        <div className="flex flex-col items-center justify-center space-y-4 text-center animate__animated animate__fadeIn">
          <div className="space-y-2">
            ...
            <h2 className="text-3xl font-bold tracking-tight text-[#1a202c] sm:text-4xl">What Our Students Say</h2>
        ...
        <div className="mx-auto grid max-w-5xl items-start gap-6 py-12 lg:grid-cols-2 lg:gap-12 animate__animated animate__fadeInUp">
          <div className="grid gap-1">
            <p className="text-[#4a5568] dark:text-gray-400">"I improved my math grades significantly with the help of my tutor. Highly recommend!"</p>
            <h3 className="text-xl font-bold">- Sarah K.</h3>
          </div>
          <div className="grid gap-1">
            <p className="text-[#4a5568] dark:text-gray-400">"The test prep sessions were very helpful and I scored higher than I expected on the SAT."</p>
